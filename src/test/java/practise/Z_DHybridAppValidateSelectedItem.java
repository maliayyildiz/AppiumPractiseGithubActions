...
public class Z_DHybridAppValidateSelectedItem {
    @Test
...
//we are on second page
        ...
        WebElement selectedItem = driver.findElement(By.id("com.androidsample.generalstore:id/productName"));

        //validate id items selected in page 2 are matching with items displayed in checkout page

        Assert.assertEquals("Jordan 6 Rings",selectedItem.getText());
